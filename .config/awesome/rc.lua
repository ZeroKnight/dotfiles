...
if beautiful.wallpaper then
    for s = 1, screen.count() do
        ...
        gears.wallpaper.centered(beautiful.wallpaper, s, nil)
    end
end
-- }}}
...
tags = {
    names = { "main", "dev", "www", "media", "irc", "term", "office", 8, 9 },
    layout = { layouts[2], layouts[2], layouts[2], layouts[1], layouts[9],
