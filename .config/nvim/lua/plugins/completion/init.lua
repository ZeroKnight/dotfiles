      ...
      return {
        ...
        formatting = {
          format = function(entry, item)
            ...
            -- Indicate that the server applied a specific sort
            local sort_indicator = entry.completion_item.sortText ~= nil and ' 󰒿 ' or ''
            ...
            item.menu = name and string.format('[%s]%s', name, sort_indicator) or ''
            return item
          end,
        },
        window = {
