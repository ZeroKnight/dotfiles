...
return {
  {
      ...
      defaults = {
        ...
        mappings = {
          i = {
            ...
            ['<C-Down>'] = function(...) return require('actions').cycle_history_next(...) end,
            ['<C-Up>'] = function(...) return require('actions').cycle_history_prev(...) end,
          },
          n = {
    ...
    keys = {
      ...
      { '<Leader>fb', util.telescope('current_buffer_fuzzy_find'), desc = 'Find in Buffer' },
